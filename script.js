    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הטרריום הראשון שלי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: '17177acd-377e-4042-be11-306b020cab4b',
                        name: data.name,
                        email: data.email,
